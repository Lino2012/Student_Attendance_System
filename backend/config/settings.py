...
# Custom Settings
LATE_COUNTS_AS_PRESENT = config('LATE_COUNTS_AS_PRESENT', default=True, cast=bool)
LOW_ATTENDANCE_THRESHOLD = config('LOW_ATTENDANCE_THRESHOLD', default=75.0, cast=float)
